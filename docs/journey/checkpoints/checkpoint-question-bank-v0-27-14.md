# Prompt Life Checkpoint Bank 0.27.14-feedback-naturalness-human-test-prep

- Active bank: v0.27.14-human-test-feedback
- Cards: 39
- Questions: 136
- Choices: 544
- Wrong-answer distractors: 408
- Questions revised: 128
- Distractors revised: 0
- Feedback items revised: 334
- Objectives revised this pass: 0
- Boilerplate feedback occurrences before: 334
- Boilerplate feedback occurrences after: 0
...
## Answer-Length Audit
- Before repair warnings: 56
- After repair warnings: 15
- Resolved warnings: 41
- Intentionally retained warnings: 15
- v02712-how-ai-learns-q5: ratio 1.58, delta 26 chars
- v02712-perfect-storm-q4: ratio 1.69, delta 33 chars
- v02712-costs-we-must-count-q1: ratio 1.68, delta 33 chars
- v02712-costs-we-must-count-q4: ratio 1.60, delta 29 chars
- v02712-risk-myth-q4: ratio 1.67, delta 34 chars
- v02712-benefits-worth-taking-seriously-q1: ratio 1.79, delta 41 chars
- v02712-benefits-worth-taking-seriously-q2: ratio 2.08, delta 46 chars
- v02712-human-centered-ai-q2: ratio 2.01, delta 45 chars
- v02712-better-ai-choice-q2: ratio 2.05, delta 38 chars
- v02712-better-ai-choice-q4: ratio 1.56, delta 28 chars
- v02712-effective-prompting-literacy-q2: ratio 1.59, delta 26 chars
- v02712-effective-prompting-literacy-q4: ratio 1.76, delta 38 chars
- v02712-model-literate-synthesis-q1: ratio 1.56, delta 41 chars
- v02712-model-literate-synthesis-q4: ratio 1.67, delta 36 chars
- v02712-model-literate-synthesis-q5: ratio 1.93, delta 49 chars
...
- Choices:
  - v0279-what-is-llm-q1-correct: It scores next tokens from context, appends one, and repeats. (correct)
...
- Choices:
  - v0279-what-is-llm-q2-correct: It generated tokens from context and learned patterns; fluency is not awareness. (correct)
...
- Choices:
  - v02712-where-llms-fit-q2-correct: AI is broad; ML learns from data; LLMs generate language or code. (correct)
...
- Choices:
  - v02712-history-q3-correct: The product is hybrid; the LLM remains learned-pattern AI. (correct)
...
- Choices:
  - v0279-training-q2-correct: It uses fixed weights and temporary context; the chat does not rewrite weights. (correct)
...
- Choices:
  - v0279-training-q3-correct: Training changes reusable weights; inference uses temporary computation. (correct)
...
- Choices:
  - v0279-pretraining-q1-correct: Next-token loss changes weights over many training steps. (correct)
...
- Choices:
  - v0279-overfitting-generalization-q3-correct: It fit narrow examples too closely instead of generalizing. (correct)
...
- Choices:
  - v02712-fine-tuning-q1-correct: Fine-tune weights or adapters for future responses. (correct)
  ...
  - v02712-fine-tuning-q1-2-prompt: Paste the norms into one user prompt.
    - feedback: A prompt can steer the current run, but it is not durable training. This makes a current-use step permanent; ordinary prompts, retrieval, and inference do not automatically rewrite weights.
  ...
  - v02712-fine-tuning-q1-3-rag: Retrieve a policy page into the current context.
    - feedback: Retrieval adds temporary evidence; it does not by itself fine-tune weights. This makes a current-use step permanent; ordinary prompts, retrieval, and inference do not automatically rewrite weights.
  ...
  - v02712-fine-tuning-q1-4-sampling: Sample from a lower-temperature distribution.
    - feedback: Sampling changes a generation-time choice, not the model pattern carried forward. This moves the job to a neighboring model step; tokenization, embeddings, layers, scores, and sampling do different work.
...
- Choices:
  - v02710-fine-tuning-q2-correct: Adapted weights or adapters can carry the pattern into later runs. (correct)
...
- Choices:
  - v02710-alignment-q1-correct: Behavior was shaped toward safety boundaries, not moral understanding. (correct)
...
- Choices:
  - v02710-alignment-q3-correct: Shaped behavior can still fail or trade off in new situations. (correct)
...
- Choices:
  - v02710-inference-q3-correct: The earlier line is still in context, so inference can use it. (correct)
...
- Choices:
  - v02710-tokens-q1-correct: Tokens can be uneven chunks: words, word pieces, or punctuation. (correct)
...
- Choices:
  - v02712-vectors-q2-correct: Features are distributed across dimensions, not one label each. (correct)
...
- Choices:
  - v02712-vectors-q3-correct: One vector can be learned; another can be temporary. (correct)
...
- Choices:
  - v02712-tensors-q1-correct: A tensor is a shaped block of numbers for model operations. (correct)
...
- Choices:
  - v02712-tensors-q2-correct: Weight tensors can persist; activation tensors are temporary. (correct)
...
- Choices:
  - v02712-attention-q2-correct: Learned attention weights persist; one prompt pattern is temporary. (correct)
...
- Choices:
  - v02712-attention-q4-correct: Inside transformer layers, shaping temporary hidden states. (correct)
...
- Choices:
  - v02712-layers-q3-correct: Layers are repeated numerical transformations, not thought steps. (correct)
...
- Choices:
  - v02712-hidden-states-q1-correct: Layer operations shape a temporary vector for that token position. (correct)
...
- Choices:
  - v02712-hidden-states-q2-correct: It is internal numerical data, not visible text. (correct)
...
- Choices:
  - v02712-hidden-states-q4-correct: Hidden states carry context-shaped information toward next-token scores. (correct)
...
- Choices:
  - v02712-sampling-q3-correct: Sampling can choose among likely tokens, not one fixed path. (correct)
...
- Choices:
  - v02712-context-window-q2-correct: Context is current input; memory needs a separate saved mechanism. (correct)
...
- Choices:
  - v02712-context-window-q4-correct: Generated tokens append, so later steps can attend to them. (correct)
...
- Choices:
  - v02712-rag-retrieval-q3-correct: RAG supplies temporary context; it does not change weights by itself. (correct)
...
- Choices:
  - v02712-rag-retrieval-q4-correct: RAG gives temporary evidence, but retrieval or generation can still fail. (correct)
...
- Choices:
  - v02712-grounding-q1-correct: Evidence does not guarantee the answer stays connected. (correct)
...
- Choices:
  - v02712-grounding-q2-correct: Generated claims to available documents, data, or tool results. (correct)
...
- Choices:
  - v02712-grounding-q4-correct: RAG supplies evidence; grounding checks whether the answer uses it. (correct)
...
- Choices:
  - v02712-hallucinations-q4-correct: Use evidence, constraints, and human review for important claims. (correct)
...
- Choices:
  - v02712-how-ai-learns-q5-correct: People may use it as temporary context even when weights did not change. (correct)
...
- Choices:
  - v02712-diffusion-q3-correct: Text autoregression is not how all generative systems work. (correct)
...
- Choices:
  - v02712-multimodal-q3-correct: An AI product can combine different media models and methods. (correct)
...
- Choices:
  - v02712-perfect-storm-q2-correct: Human work and incentives helped turn methods into products. (correct)
...
- Choices:
  - v02712-collective-intelligence-q2-correct: It points to provenance, consent, pay, and power around data/labor. (correct)
...
- Choices:
  - v02712-benefits-worth-taking-seriously-q3-correct: Taking benefits seriously does not mean believing in utopia. (correct)
...
- Choices:
  - v02712-effective-prompting-literacy-q3-correct: Ask for sources or retrieval; do not trust citation-shaped output alone. (correct)
...
- Choices:
  - v02712-model-literate-synthesis-q2-correct: Weights persist; context and states are temporary; retrieval adds context. (correct)
...
- Choices:
  - v02712-model-literate-synthesis-q3-correct: Look for grounding, sources, uncertainty, and human review. (correct)
